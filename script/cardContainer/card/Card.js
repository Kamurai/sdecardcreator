...
function Card(animate,appendAfter){
  ...
  this.initFirstCard=function(){
    //hero
    var data = {"name":"Ability 1","costType":"attack","cost":1,"definition":"+1R -2B 3G 4O 5P 1ST 0MI 1MA 2SW 3RG STR WILL DEX ARM 1AC 2MO 0SH +1HE ALLAFFINITY AMETHYST AMETHYSTCITRINE CITRINE CITRINEEMERALD EMERALD EMERALDRUBY RUBY RUBYSAPPHIRE SAPPHIRE SAPPHIRECITRINE AUGMENT DANGEROUS BANE HEX FIRE KNOCKDOWN ICE IMMOBILE POISON SLOW ALL IMMUNEBANE IMMUNEHEX IMMUNEFIRE IMMUNEKNOCKDOWN IMMUNEICE IMMUNEIMMOBILE IMMUNEPOISON IMMUNESLOW IMMUNEALL"};
